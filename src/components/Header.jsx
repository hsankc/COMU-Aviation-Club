...
export default function Header() { 
  ...
  return (
    <header className={`z-50 fixed w-full top-0 transition-all duration-500 ${scrolled ? 'glass shadow-md py-2' : 'bg-white/80 backdrop-blur-sm py-3'}`}>
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
        <a href="#hero" className="flex items-center gap-3 group">
          <img 
            src="/club-logo.png" 
            alt="ÇOMÜ Havacılık Kulübü" 
            className="w-14 h-14 object-contain animate-[shimmer_3s_ease-in-out_infinite] drop-shadow-md"
          />
          <span className="font-space font-bold text-base tracking-wider text-slate-900 uppercase hidden sm:block">
        ...
        <nav className="hidden lg:flex gap-5 items-center">
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              <span className="text-[8px] text-slate-400 font-space font-bold tracking-[0.2em] uppercase leading-tight">Powered By</span>
